...
Curated rules format v16 makes applicability, review state, contribution role, typed
...
Curated-rule files older than format v16 must be migrated before ingestion.
