...
Curated rules format v17 makes applicability, review state, contribution role, typed
...
Curated-rule files older than format v17 must be migrated before ingestion.
