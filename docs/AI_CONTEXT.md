...
- 2026-09-22: Milestone 2B Peripheral identity/relationship research is now materialized in
  the Army application database. Schema 20 / compatibility revision 28 retains the reviewed
...
- 2026-09-22: Schema 20 / compatibility revision 28 materializes the 95 fully resolved
  ...
  Unit detail reads expose these as `selection_constraints`. The 23 selector-bearing resolved
  relations and eight unresolved-placeholder relations remain source/context data pending selector
  grammar review.
